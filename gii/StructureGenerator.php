...
namespace crudschool\migrik\gii;

use crudschool\migrik\contracts\IMigrationColumnResolver;
use crudschool\migrik\contracts\IMigrationTableResolver;
use crudschool\migrik\resolver\TableResolver;
use Yii;
